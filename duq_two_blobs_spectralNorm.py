...
class duq(nn.Module):
	def __init__(self, input_size=2, features=20, output_size=20, num_classes=2):
		...
		self.fc1 = nn.utils.spectral_norm(nn.Linear(input_size, features))
		self.fc2 = nn.utils.spectral_norm(nn.Linear(features, features))
		self.fc3 = nn.Linear(features, output_size)
		#self.bn1 = nn.utils.spectral_norm(features)
		#self.bn2 = nn.utils.spectral_norm(features)
	...
	def update_embeddings(self, x, y):
		z = self.embed(x) # num_points x num_centroids x num_classes
