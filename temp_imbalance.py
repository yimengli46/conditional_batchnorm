...
def vis_points(X, Y, name='temp', mode='write'):
...
centers = [(5, 5)]
train_X_2, train_Y_2 = make_blobs(n_samples=n_train_samples, centers=centers, shuffle=False, random_state=40)
train_Y_2 = np.ones((train_Y_2.shape), dtype=int)
n_train_samples = 55000
train_X = np.concatenate((train_X, train_X_2), axis=0)
train_Y = np.concatenate((train_Y, train_Y_2))
vis_points(train_X, train_Y, mode='show')
