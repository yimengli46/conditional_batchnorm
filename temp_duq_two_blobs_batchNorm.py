...
# select out points distance to (0, 0) larger than 5
dist = np.sqrt(train_X[:,0]**2+train_X[:,1]**2)
mask_boundary = np.logical_and(dist > 5, train_Y==0)
y_train_targets[mask_boundary, 0] = 0
#assert 1==2
